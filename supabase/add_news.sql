...
(2, 'warning', 'Student Visa Alert', 'Cảnh Báo Visa Du Học',
 ...
 '[
   ...
   {"q_en":"I finish high school in August 2026 with an I-94 valid to August 2027, then start a 4-year college program. What happens to my I-94?","a_en":"Your I-94 \"admit until\" date (August 2027) is tied to your high school program — starting college does not automatically extend or reset it, and neither does the college issuing a new I-20 or updating SEVIS. Because college is a new program that runs past that date, you must obtain a new period of admission: file Form I-539 (Extension of Stay) with USCIS using your new college I-20 — with the fee and biometrics — before your August 2027 date, or depart the US and re-enter with the new I-20 so CBP issues a fresh I-94 for the college program (up to four years). Moving from high school up to a bachelor''s is an allowed step up in level; file the I-539 early so a timely filing keeps you in authorized status while it is pending, and confirm the exact timing and documents with your DSO and an immigration attorney before your current I-94 expires.","q_vi":"Tôi học xong trung học vào tháng 8/2026 với I-94 có hiệu lực đến tháng 8/2027, rồi vào đại học 4 năm. Mẫu I-94 của tôi sẽ ra sao?","a_vi":"Ngày kết thúc lưu trú (\"admit until\") trên I-94 của bạn (tháng 8/2027) gắn với chương trình trung học — việc vào đại học KHÔNG tự động gia hạn hay đặt lại ngày đó, và việc trường đại học cấp I-20 mới hay cập nhật SEVIS cũng không. Vì đại học là chương trình mới kéo dài quá ngày đó, bạn phải xin một thời hạn nhập cảnh mới: nộp Mẫu I-539 (Gia Hạn Lưu Trú) cho USCIS kèm I-20 mới của trường đại học — cùng lệ phí và sinh trắc học — trước ngày tháng 8/2027, hoặc rời Hoa Kỳ rồi nhập cảnh lại với I-20 mới để CBP cấp I-94 mới cho chương trình đại học (tối đa 4 năm). Chuyển từ trung học lên chương trình cử nhân là bước tiến lên bậc học cao hơn nên được phép; hãy nộp I-539 sớm để việc nộp đúng hạn giúp bạn duy trì tình trạng hợp lệ trong khi chờ xét duyệt, và xác nhận thời điểm cùng giấy tờ chính xác với cố vấn nhà trường (DSO) và luật sư di trú trước khi I-94 hiện tại của bạn hết hạn."},
   {"q_en":"I''m finishing an ESL / English-language program and want to start a bachelor''s degree — what should I do?","a_en":"Moving up from ESL to a degree program is an allowed step up in academic level. Ask the university''s DSO for a new Form I-20 for the bachelor''s program, then get a new period of admission before your current I-94 \"admit until\" date: either file Form I-539 (Extension of Stay) with USCIS using the new I-20 — with the fee and biometrics — or depart the US and re-enter with the new I-20 so CBP issues a fresh I-94 (up to four years). Note that undergraduate students generally cannot change schools during their first academic year without an SEVP exception, so confirm your timing with your DSO and, ideally, an immigration attorney before your I-94 expires.","q_vi":"Tôi sắp hoàn thành chương trình tiếng Anh (ESL) và muốn bắt đầu chương trình cử nhân — tôi nên làm gì?","a_vi":"Chuyển từ ESL lên chương trình cấp bằng là bước tiến lên bậc học cao hơn nên được phép. Hãy xin cố vấn nhà trường (DSO) của trường đại học cấp mẫu I-20 mới cho chương trình cử nhân, sau đó xin một thời hạn nhập cảnh mới trước ngày kết thúc lưu trú (\"admit until\") trên I-94 hiện tại: hoặc nộp Mẫu I-539 (Gia Hạn Lưu Trú) cho USCIS kèm I-20 mới — cùng lệ phí và sinh trắc học — hoặc rời Hoa Kỳ rồi nhập cảnh lại với I-20 mới để CBP cấp I-94 mới (tối đa 4 năm). Lưu ý sinh viên đại học thường không được đổi trường trong năm học đầu tiên nếu không có ngoại lệ từ SEVP, vì vậy hãy xác nhận thời điểm với cố vấn nhà trường (DSO) và tốt nhất là luật sư di trú trước khi I-94 hết hạn."},
   {"q_en":"I''m finishing a 2-year (associate) degree and transferring to a 4-year university — what happens to my I-94?","a_en":"Completing your associate degree and moving up to a bachelor''s is an allowed progression to a higher level. Your new university issues a new Form I-20 and updates SEVIS, but that alone does not change your Form I-94 \"admit until\" date. To get time for the 4-year program you must either file Form I-539 (Extension of Stay) with USCIS before your I-94 date — with the new I-20, fee, and biometrics — or depart and re-enter so CBP issues a fresh I-94. This is different from transferring mid-program: if you leave the associate program before finishing it, the new first-year transfer limits may apply. File early and check with your DSO and an attorney.","q_vi":"Tôi sắp hoàn thành chương trình cao đẳng 2 năm (associate) và chuyển lên đại học 4 năm — mẫu I-94 của tôi sẽ ra sao?","a_vi":"Hoàn thành bằng cao đẳng và tiến lên chương trình cử nhân là bước tiến lên bậc học cao hơn nên được phép. Trường đại học mới sẽ cấp mẫu I-20 mới và cập nhật SEVIS, nhưng riêng điều đó KHÔNG thay đổi ngày kết thúc lưu trú (\"admit until\") trên mẫu I-94 của bạn. Để có thời gian cho chương trình 4 năm, bạn phải hoặc nộp Mẫu I-539 (Gia Hạn Lưu Trú) cho USCIS trước ngày I-94 — kèm I-20 mới, lệ phí và sinh trắc học — hoặc rời đi rồi nhập cảnh lại để CBP cấp I-94 mới. Điều này khác với chuyển trường giữa chừng: nếu bạn rời chương trình cao đẳng trước khi hoàn thành, quy định hạn chế chuyển trường trong năm đầu có thể áp dụng. Hãy nộp sớm và kiểm tra với cố vấn nhà trường (DSO) và luật sư."},
   {"q_en":"My I-20 and I-94 expire in about a year but I won''t finish my program in time — how do I get more time?","a_en":"First ask your DSO for a program extension and a new Form I-20 with a later end date (you generally need a valid academic reason, such as a changed major or a documented medical delay — not poor grades). Then file Form I-539 (Extension of Stay) with USCIS before your I-94 \"admit until\" date, with the fee and biometrics. Filing on time keeps you in authorized status while USCIS decides, but if the extension is denied there is no grace period — so start months early and keep proof of your timely filing.","q_vi":"Mẫu I-20 và I-94 của tôi hết hạn khoảng một năm nữa nhưng tôi sẽ không kịp hoàn thành chương trình — làm sao để có thêm thời gian?","a_vi":"Trước tiên hãy xin cố vấn nhà trường (DSO) gia hạn chương trình và cấp mẫu I-20 mới với ngày kết thúc muộn hơn (thường bạn cần lý do học thuật hợp lệ, như đổi ngành hoặc chậm trễ vì lý do y tế có giấy tờ — không phải vì điểm kém). Sau đó nộp Mẫu I-539 (Gia Hạn Lưu Trú) cho USCIS trước ngày kết thúc lưu trú (\"admit until\") trên I-94, kèm lệ phí và sinh trắc học. Nộp đúng hạn giúp bạn duy trì tình trạng hợp lệ trong khi USCIS xét duyệt, nhưng nếu bị từ chối thì KHÔNG có thời gian ân hạn — vì vậy hãy bắt đầu sớm nhiều tháng và giữ bằng chứng đã nộp đúng hạn."},
   ...
   {"q_en":"Can I travel home to visit my family and come back to continue my studies?","a_en":"Yes, but plan carefully. To re-enter you need a valid, unexpired F-1 visa; if your visa has expired you must renew it at a US consulate abroad, which can involve wait times and extra scrutiny. Carry a current Form I-20 signed for travel by your DSO (within the last year), proof of enrollment, and proof of funds. When you re-enter after September 15, 2026, CBP issues a fixed I-94 tied to your program (up to four years). Don''t travel just to \"reset\" your I-94 — re-entry is never guaranteed, and if a visa or entry is refused you could be stuck outside the US. If your visa is expired or your status is at all complicated, talk to an attorney before booking.","q_vi":"Tôi có thể về thăm gia đình rồi quay lại tiếp tục việc học không?","a_vi":"Có, nhưng hãy lên kế hoạch cẩn thận. Để nhập cảnh lại, bạn cần visa F-1 còn hiệu lực; nếu visa đã hết hạn, bạn phải xin cấp lại tại lãnh sự quán Hoa Kỳ ở nước ngoài, việc này có thể mất thời gian chờ và bị xét duyệt kỹ hơn. Hãy mang theo mẫu I-20 hiện hành có chữ ký cho phép đi lại của cố vấn nhà trường (DSO) (trong vòng một năm), bằng chứng đang theo học và bằng chứng tài chính. Khi bạn nhập cảnh lại sau ngày 15/9/2026, CBP sẽ cấp I-94 cố định theo chương trình của bạn (tối đa 4 năm). Đừng đi chỉ để \"đặt lại\" I-94 — việc nhập cảnh không bao giờ được bảo đảm, và nếu bị từ chối visa hoặc nhập cảnh, bạn có thể bị kẹt ngoài Hoa Kỳ. Nếu visa đã hết hạn hoặc tình trạng của bạn phức tạp, hãy trao đổi với luật sư trước khi đặt vé."},
